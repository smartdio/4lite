...
const runtimeRelative='public/assets/models/concrete-slide/concrete-slide-game-optimized-v01.glb'
const candidateRelative='artifacts/performance/phase6m/concrete-slide-meshopt-candidates/concrete-slide-meshopt-conservative.glb'
const archiveRelative='archive/phase-6m-pre-concrete-slide-meshopt/public/assets/models/concrete-slide/concrete-slide-game-optimized-v01.glb'
const reportRelative='artifacts/performance/phase6m/applied-report.json'
...
const report={
  phase:'6M',appliedAt:new Date().toISOString(),tool:'@gltf-transform/cli@4.4.2 meshopt',
  ...
  restore:`Copy ${archiveRelative} back to ${runtimeRelative} and restore the runtime URL to ?v=1.`,
}
