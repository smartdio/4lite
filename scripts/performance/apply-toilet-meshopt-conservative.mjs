...
const runtimeRelative='public/assets/models/toilet/toilet-game-optimized-v01.glb'
const candidateRelative='artifacts/performance/phase6l/toilet-meshopt-candidates/toilet-meshopt-conservative.glb'
const archiveRelative='archive/phase-6l-pre-toilet-meshopt/public/assets/models/toilet/toilet-game-optimized-v01.glb'
const reportRelative='artifacts/performance/phase6l/applied-report.json'
...
const report={
  phase:'6L',appliedAt:new Date().toISOString(),tool:'@gltf-transform/cli@4.4.2 meshopt',
