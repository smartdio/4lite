...
import {bindLocalePreferenceLinks,initialLocaleRedirect,rememberLocalePreference} from './i18n/locale-preference.js'
import {renderEntryShell} from './ui/entry-shell.js'
import './style.css'

const localeRedirect=initialLocaleRedirect()
if(localeRedirect)window.location.replace(localeRedirect)
else initializeEntry()

function initializeEntry(){
  rememberLocalePreference(currentLocale)
